...
public class BatteryLife extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.battery_life);
    ...
    public String getData(){
        ...
        String my_urlbl = "http://ec2-35-164-181-39.us-west-2.compute.amazonaws.com/batterylife.php";
        ...
        try{
            HttpClient httpclient = new DefaultHttpClient();
            HttpPost httppost = new HttpPost(my_urlbl); //YOUR PHP SCRIPT ADDRESS
            HttpResponse response = httpclient.execute(httppost);
            HttpEntity entity = response.getEntity();
            isr = entity.getContent();
        }
        ...
        try{
            ...
            resultOne=sb.toString();
            Log.d("BatteryLife",resultOne);
            tvv.setText("Battery Life \n        "+resultOne+"%");
        }
        catch(Exception e){
