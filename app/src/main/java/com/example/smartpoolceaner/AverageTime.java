...
public class AverageTime extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.average_time);
    ...
    public String getData(){;
        ...
        String my_url = "http://ec2-35-164-181-39.us-west-2.compute.amazonaws.com/averagetime.php";
        ...
        try{
            ...
            result=sb.toString();
            Log.d("AverageTime",result);
            tv.setText("Average Time \n       "+result+" Hrs");
        }
        catch(Exception e){
