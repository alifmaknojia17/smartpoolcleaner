...
public class CleaningFrequency extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cleaning_frequency);
    ...
    public String getData(){;
        ...
        String my_url = "http://ec2-35-164-181-39.us-west-2.compute.amazonaws.com/cleaningfrequency.php";
        ...
        try{
            ...
            resulttwo=sb.toString();

            Log.d("CleaningFrequency",resulttwo);

            tw.setText("Cleaning Frequency \n           " + resulttwo + " times\n         Per Month");
